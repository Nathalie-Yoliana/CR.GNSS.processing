...
Stats=('ABEJ','AROL', 'BIJA', 'BON2', 'BRBR', 'CABA','CAPO') # above not processed at cwu
meanList=('ABEJ','AROL', 'BIJA', 'BON2', 'BRBR') # get daily average of these stations for net-average
